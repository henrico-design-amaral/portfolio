...
const COPY = {
  pt: {
    ...
    'imp4.type':    'Banking / compliance',
     ...
     'ab.p3':             'Atuei em projetos para Petrobras, Bayer, Ambev, Banco do Brasil, Bradesco, Claro, Globo, iFood, BMG e Youse. Em comum, esses projetos tinham o mesmo desafio: transformar complexidade em sistemas mais claros, confiáveis e fáceis de operar.',
     'ab.p4':             'Não parto da tela. Parto do problema, do fluxo, das regras e das decisões que o sistema precisa sustentar.',
      ...
      'ab.photo.caption': 'Henrico Amaral<br>Senior Product Designer · Decision Infrastructure<br>São Paulo · Remoto / Híbrido · PT/EN',
     'ab.card1.title':    'Senior Product Designer',
     'ab.card1.items':    '<li>Plataformas B2B</li><li>Sistemas internos</li><li>Workflows complexos</li><li>Ambientes regulados</li>',
     'ab.card2.title':    'Complexidade operacional',
     'ab.card2.items':    '<li>Fluxos confusos</li><li>Dados dispersos</li><li>Regras de negócio</li><li>Múltiplos stakeholders</li>',
     'ab.card3.title':    'Estrutura antes da interface',
     'ab.card3.items':    '<li>Discovery</li><li>Arquitetura da informação</li><li>Fluxos e estados</li><li>Prototipação</li>',
     'ab.card4.title':    'Projetos enterprise',
     ...
     'ab.card5.items':    '<li>Figma</li><li>Miro / FigJam</li><li>AccessMonitor</li><li>GitHub</li><li>IA generativa</li>',
     ...
     'ct.title':          'Vamos falar sobre o seu<br>próximo sistema complexo.',
     'ct.sub':            'Para vagas sêniores, projetos enterprise, plataformas internas ou conversas técnicas sobre produto, operação e decisão.',
     ...
     'ct.card3.text':     'Arquitetura da informação, IA aplicada, prototipação e clareza operacional.',
     'ct.cv':             'Ver CV',
     'ct.cases':          'Ver cases',
   ...
   en: {
     ...
     'ab.p4':             'I don’t start from the screen. I start from the problem, the workflow, the rules and the decisions the system needs to support.',
      ...
      'ab.photo.caption': 'Henrico Amaral<br>Senior Product Designer · Decision Infrastructure<br>São Paulo · Remote / Hybrid · PT/EN',
     'ab.card1.title':    'Senior Product Designer',
     'ab.card1.items':    '<li>B2B platforms</li><li>Internal systems</li><li>Complex workflows</li><li>Regulated environments</li>',
     'ab.card2.title':    'Operational complexity',
     'ab.card2.items':    '<li>Messy workflows</li><li>Scattered data</li><li>Business rules</li><li>Multiple stakeholders</li>',
     'ab.card3.title':    'Structure before interface',
     'ab.card3.items':    '<li>Discovery</li><li>Information architecture</li><li>Flows and states</li><li>Prototyping</li>',
     'ab.card4.title':    'Enterprise projects',
     ...
     'ab.card5.items':    '<li>Figma</li><li>Miro / FigJam</li><li>AccessMonitor</li><li>GitHub</li><li>Generative AI</li>',
     ...
     'ct.title':          'Let’s talk about your<br>next complex system.',
     'ct.sub':            'For senior roles, enterprise projects, internal platforms or technical conversations about product, operations and decision-making.',
     ...
     'ct.card3.text':     'Information architecture, applied AI, prototyping and operational clarity.',
     'ct.cv':             'View CV',
     'ct.cases':          'View cases',
