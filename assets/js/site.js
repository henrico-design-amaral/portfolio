...
const COPY = {
  pt: {
    ...
    'm1.label':     'Observabilidade Operacional',
    'm1.desc':      'Mapeamento contínuo de sinais, eventos distribuídos e dependências críticas antes da definição de qualquer fronteira visual.',
    'm2.label':     'Arquitetura Relacional',
    'm2.desc':      'Modelagem de grafos de interação, máquinas de estado e ontologias sistêmicas para garantir integridade e coerência sob carga.',
    'm3.label':     'Estrutura Cognitiva',
    'm3.desc':      'Definição de densidade informacional, hierarquia de acesso temporal e priorização de dados baseada em matrizes de risco.',
    'm4.label':     'Superfícies de Decisão',
    'm4.desc':      'Tradução final da lógica de negócio em interfaces operacionais focadas na mitigação de erros e coordenação de respostas.',
    's5.tag':       '04 / Impacto',
   ...
   en: {
     ...
     'm1.label':     'Operational Observability',
     'm1.desc':      'Continuous mapping of signals, distributed events, and critical dependencies before defining any visual boundary.',
     'm2.label':     'Relational Architecture',
     'm2.desc':      'Modeling interaction graphs, state machines, and systemic ontologies to ensure integrity and coherence under load.',
     'm3.label':     'Cognitive Structure',
     'm3.desc':      'Definition of informational density, temporal access hierarchy, and data prioritization based on risk matrices.',
     'm4.label':     'Decision Surfaces',
     'm4.desc':      'Final translation of business logic into operational interfaces focused on error mitigation and response coordination.',
     's5.tag':       '04 / Impact',
